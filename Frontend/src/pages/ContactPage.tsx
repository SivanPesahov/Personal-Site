...
export default function ContactPage() {
  return (
    <div className="flex flex-col  items-center  min-h-screen px-4 lg:text-left lg:py-[4vh]">
      <div className="sm:mb-10 py-[2vh] lg:py-0 px-6">
      ...
      <div className="my-2 sm:w-[90%] md:w-[60%]">
        <ContactForm />
      </div>
